<aside class="main-sidebar sidebar-light-teal elevation-4">
    ...
    <a href="" class="brand-link">
        <img src="{{ asset('templates/backend/AdminLTE-3.1.0') }}/dist/img/logo_nusan.png" alt="Nusantara Logo"
            class="brand-image " style=" margin-left:2%; opacity: .8;width:70px">
        <span class="brand-text font-weight-light" style=" font-family: Lato;font-weight:400px">Website SPP</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="my-auto ml-3">
                <i class="nav-icon fas fa-user-circle fa-2x text-drak"></i>
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             with font-awesome or any other icon font library -->
                ...
                @role('admin')
                    <li class="nav-header">PERAN - PERIZINAN</li>
                    <li class="nav-item">
